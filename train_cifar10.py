...
A = [
	#('cifar10_cnn64_full', 64, [], [0]),
	#('cifar10_cnn64_del0', 64, [0], []),
	#('cifar10_cnn256_full', 256, [], [0]),
	#('cifar10_cnn256_del0', 256, [0], []),
	#('cifar10_cnn256_del0_second', 256, [0], []),
	('cifar10_cnn1024_full', 1024, [], [0]),
	('cifar10_cnn1024_del0', 1024, [0], []),
]

for (NAME, DENSE_UNITS, TRAIN_FILTER, TRANSFER_FILTER) in A:
